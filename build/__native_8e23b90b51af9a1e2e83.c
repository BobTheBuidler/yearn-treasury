...
char CPyDef_budget_____top_level__(void) {
    ...
    CPy_DECREF(cpy_r_r4);
CPyL3: ;
    cpy_r_r5 = CPyStatics[74]; /* ('BudgetRequest',) */
    ...
    CPy_DECREF(cpy_r_r8);
    cpy_r_r9 = CPyStatics[75]; /* ('approved_requests', 'rejected_requests', 'requests') */
...
char CPyDef__request_____top_level__(void) {
    ...
    CPy_DECREF(cpy_r_r4);
CPyL3: ;
    cpy_r_r5 = CPyStatics[76]; /* ('dataclass',) */
    ...
    CPy_DECREF(cpy_r_r8);
    cpy_r_r9 = CPyStatics[77]; /* ('getLogger',) */
    ...
    CPy_DECREF(cpy_r_r12);
    cpy_r_r13 = CPyStatics[78]; /* ('Final', 'Optional', 'Set', 'final') */
    ...
    cpy_r_r115 = CPyStatics[79]; /* ('frozen',) */
...
PyObject *CPyDef__requests___fetch_brs(void) {
    ...
    cpy_r_r5 = CPyStatics[72]; /* 100 */
    cpy_r_r6 = CPyStatics[73]; /* 1 */
...
CPyL7: ;
    ...
    cpy_r_r16 = CPyStatics[80]; /* ('headers', 'params') */
...
CPyL3: ;
    ...
    cpy_r_r10 = CPyStatics[82]; /* (('os', 'os', 'os'),) */
    cpy_r_r11 = CPyStatic__requests___globals;
    ...
    cpy_r_r19 = CPyStatics[84]; /* ('Final', 'List') */
    ...
    cpy_r_r23 = CPyStatics[74]; /* ('BudgetRequest',) */
...
const int CPyLit_Tuple[] = {
    ...
    51, 3, 62, 62, 62, 1, 81, 1, 49, 2, 22, 65
};
