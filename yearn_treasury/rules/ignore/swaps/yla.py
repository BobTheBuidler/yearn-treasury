...
def is_yla_deposit(tx: TreasuryTx) -> bool:
    return (
        tx.hash == "0x1d4e974db2d60ebd994410fcd793c5db771af9a14660015faf94cbdaec285009"
        and (tx.symbol == "YLA" or tx.to_address.address == "0x9ba60bA98413A60dB4C651D4afE5C937bbD8044B")  # type: ignore [union-attr]
    )
