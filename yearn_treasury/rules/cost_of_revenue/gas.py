...
_STRATEGIST_GAS_HASHES: Final[Set[HexStr]] = {
    Network.Mainnet: {
        ...
        "0xecbc1474610b31046124aa6323863f47d6e348385056ab80c3cc1f6b963f5d68",
        "0x5fb3320fdc41aba54743559cd4248e5cdfd8ffc67bd329c13cd3b66ce4976144",
        "0x7afceac28536b9b2c177302c3cfcba449e408b47ff2f0a8a3c4b0e668a4d5d4e",
        "0xb8bb3728fdfb49d7c86c08dba8e3586e3761f13d2c88fa6fab80227b6a3f4519",
        "0x76635bffdf8ee07736bf6953611cd93b5f6f10ef9a59f2504661047e834ea4d6",
...
def is_strategist_gas(tx: TreasuryTx) -> bool:
    if tx.symbol == "ETH":
        if tx.from_nickname == "Disperse.app":
            return (
                tx.hash in _STRATEGIST_GAS_HASHES
                or (
                    tx.symbol == "ETH"
                    and tx.hash == "0xebfff9a2fd6103d73f417c675db2dc43742bdb6f496f04d3cfd1938046001d70"
                )
            )
