...
yteams_addresses = {
    Network.Mainnet: {
        "v3": {"ms": "0x33333333D5eFb92f19a5F94a43456b3cec2797AE","splits":{"0x2A12CAA2c13Af03c117D836CA3811a5Ca946133B":12.5}},
        "dinobots": {"ms": "0x2C01B4AD51a67E2d8F02208F54dF9aC4c0B778B6","splits":{"0xC4f238633A85A854C4702d2c66264771D1fa7904":17.5}},
        "ylockers": {"ms": "0x4444AAAACDBa5580282365e25b16309Bd770ce4a","splits":{"0xac580302548FCCBBf00020de20C3A8AA516821AD":2.5,"0x794f80E899c772de9E326eC83cCfD8D94e208B49":6.25, "0x5FF0f87b05806ce89967638CA727Af8309d92A89":12.5, "0x5A7575368797695BefD785f546C6b8B7e9D37f8c":15.625}},
        ...
        "yaudit": {"ms": "0x8973B848775a87a0D5bcf262C555859b87E6F7dA","splits":{"0xd7A1DBe236A38528D54317415a530b2326068373":35,"0xF104F38592287e25868BD8C3dcCCa1a311916f88":35,"0x1a9D272C3b7fE427639702A332D51348213B0bC1":20}},
        "yeth": {"ms": "0xeEEEEeeeEe274C3CCe13f77C85d8eBd9F7fd4479","splits":{"0x14EFe6390C6758E3fE4379A14e3B329274b1b072":25}},
...
async def calculate_teams_revenue_expenses() -> None:
    ...
    logger.info(f"Finished processing yteams calculations and saved file to {os.path.abspath(OUTPUT_FILE)}")


def get_timestamps_for_report() -> List[datetime]:
    now = datetime.now(tz=timezone.utc)
    prev_month_end = datetime(year=now.year, month=now.month, day=1, hour=0, minute=0, second=0, microsecond=0, tzinfo=timezone.utc) - timedelta(microseconds=1)
    datetimes = []
        ...
        if transfer.price:
            if transfer.from_address != ZERO_ADDRESS:
                try:
                    ...
                    if (hasattr(contract, 'recipient') and await contract.recipient == wallet) \
